...
The API is currently contract-first and memory-backed. The next implementation pass should replace the in-memory store with PostgreSQL persistence and wire uploaded assets into MinIO.
